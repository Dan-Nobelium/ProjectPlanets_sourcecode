...
var probability_trade = [[.5],[.5]];
  var probability_shield = [[.5],[.5]];
...
'<img src= "./img/logo.png"></img>' +
  ...
  '<embed src="stuff/PIS_SONA_3385.pdf" width="800px" height="2100px" />' +
...
jsPsych.init({
  ...
  on_finish: function() {
    ...
    // Local JSON download, calls downloadJSON function
    downloadJSON(jsonData, 'experiment_data.json');
