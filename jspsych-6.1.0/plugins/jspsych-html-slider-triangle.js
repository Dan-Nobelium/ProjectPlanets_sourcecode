...
function getImagePosition(index, trial) {
  var vertexX, vertexY;

  switch (index) {
    case 0: // Planet A (Left vertex)
      vertexX = 0;
      vertexY = trial.slider_height / 2;
      break;
    case 1: // Planet B (Right vertex)
      vertexX = trial.slider_width;
      vertexY = trial.slider_height / 2;
      break;
    case 2: // Planet C (Bottom vertex)
      vertexX = trial.slider_width / 2;
      vertexY = trial.slider_height;
      break;
    default:
      vertexX = 0;
      vertexY = 0;
  ...
  var x = vertexX - trial.stimulus_height / 2;
  var y = vertexY - trial.stimulus_height / 2;
...
function getLabelPosition(index, trial) {
  var vertexX, vertexY;

  switch (index) {
    case 0: // Planet A (Left vertex)
      vertexX = trial.stimulus_height / 2;
      vertexY = trial.slider_height / 2;
      break;
    case 1: // Planet B (Right vertex)
      vertexX = trial.slider_width - trial.stimulus_height / 2;
      vertexY = trial.slider_height / 2;
      break;
    case 2: // Planet C (Bottom vertex)
      vertexX = trial.slider_width / 2;
      vertexY = trial.slider_height - trial.stimulus_height / 2;
      break;
    default:
      vertexX = 0;
      vertexY = 0;
  ...
  console.log(`Planet ${String.fromCharCode(65 + index)} label position: (${x}, ${y})`);

  return `top: ${y}px; left: ${x}px; transform: translateX(-50%);`;
}
