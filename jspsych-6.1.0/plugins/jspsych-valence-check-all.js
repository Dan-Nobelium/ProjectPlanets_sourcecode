...
jsPsych.plugins['valence-check-all'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-valence-check-4-wrapper" style="margin: 100px 0px;">';
    ...
    html += '<div id="jspsych-valence-check-4-stimulus">';
    ...
    // slider
    html += '<div class="jspsych-valence-check-4-container" style="position:relative; margin: 0 auto 3em auto; ';
    if(trial.slider_width !== null){
      html += 'width:'+trial.slider_width+'px;';
    }
    html += '">';
    html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 100%;" id="jspsych-valence-check-4-response4"></input>';
    html += '<div>'
    for(var j=0; j < trial.labels.length; j++){
      var width = 100/(trial.labels.length-1);
      var left_offset = (j * (100 /(trial.labels.length - 1))) - (width/2);
    ...
    display_element.querySelector('#jspsych-valence-check-3-next').addEventListener('click', function() {
      ...
      response.response4 = display_element.querySelector('#jspsych-valence-check-4-response4').value;
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function() {
        display_element.querySelector('#jspsych-valence-check-4-stimulus').style.visibility = 'hidden';
