...
jsPsych.plugins["planet-response-command"] = (function() {
    ...
    // Register the plugin's preload method for images
    jsPsych.pluginAPI.registerPreload('planet-response', 'stimulus', 'image');
   
    // Define the plugin's information
    plugin.info = {
      name: 'planet-response-command',
      description: '',
      parameters: {
        // The planets (image files) to be displayed
        stimulus: {
        ...
        // Stimulus selection image on mouseover
        stimulus_select: {
          type: jsPsych.plugins.parameterType.IMAGE,
        ...
        // Any content here will be displayed under the option
        prompt: {
        ...
        // Show points accumulated up to this point
        show_total_points: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Set the space between stimuli in pixels
        ship_space: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Duration of continuous block in ms
        block_duration: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Duration of trade(planet) and ship feedback
        feedback_duration: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Duration of signal image above chosen planet, in ms
        signal_time: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Blank space (padding) around signal image
        signal_padding: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Balance trade success probabilities
        trade_balance: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Probability of successful trade for each planet
        probability_trade: {
        ...
        // Show ships after planet signal response
        show_ship: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Balance ship appearance probabilities
        ship_balance: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Images for ships--one for each planet
        ship_stimulus: {
          type: jsPsych.plugins.parameterType.IMAGE,
        ...
        // Duration between ship appearance and attack
        ship_attack_time: {
          type: jsPsych.plugins.parameterType.INT,
        ...
        // Index of hostile ship, can be 0 (left), 1 (right), or 2 (top)
        ship_hostile_idx: {
          type: jsPsych.plugins.parameterType.INT,
          pretty_name: 'Index of hostile ship',
          default: 0,
          description: 'Index of hostile ship, can be 0 (left), 1 (right), or 2 (top)'
        },
        // Duration of shield charging prompt
        ...
        // Shield prevents trading when active
        ...
        // Balance shield availability probabilities
        shield_balance: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Toggle whether activating the shield incurs a cost
        shield_cost_toggle: {
          type: jsPsych.plugins.parameterType.BOOL,
        ...
        // Cursor images: 1st Element: default cursor; 2nd Element: mousedown cursor
        cursor: {
          type: jsPsych.plugins.parameterType.IMAGE,
        ...
        // The text for ship outcome 1 when unshielded
        ...
        // The text for ship outcome 2 when unshielded
        ...
        // The text for ship outcome 3 when unshielded
        ...
        // The text for ship outcome 3 when shielded
    ...
    plugin.trial = function(display_element, trial) {
      ...
      // Some general custom styles (cursor, text color, background color)
      ...
      gameContainer.style.gridTemplateColumns = '5fr 1fr'; // Allocate 5/6 width to planet row and 1/6 to command info
      ...
      if (trial.trade_balance) {
        ...
        var trade_orderbase = tradeProbArrs[0];  // Base set to randomize availability of trades
...
if (!shield_activated) {
  ...
  var outcome_text = '';
  if (choice === 0) {
    outcome_text = trial.ship_outcome_1_unshielded;
  } else if (choice === 1) {
    outcome_text = trial.ship_outcome_2_unshielded;
  } else if (choice === 2) {
    outcome_text = trial.ship_outcome_3_unshielded;
  }
  var statusmsg = outcome_text + ' -' + appliedDamage;
  var statusclr = choice === 0 ? 'red' : (choice === 1 ? 'darkorange' : 'green');
  ...
  var statusclr = choice === 2 ? 'yellow' : '#05BF00';
}
